...
/**
 * T3: typed views over the new k8s-style probes (GET /live, /ready, /models).
 * The background HealthWatch still polls /health (warming) in T3 and migrates
 * to /live + /ready in T4, so no caller uses these yet.
 */
